...
router.post('/', auth, roleGuard('Coordinador', 'Empleado'), validate(createSacramentSchema, 'body'), SacramentController.create);
router.put('/:id', auth, roleGuard('Coordinador', 'Empleado'), validate(paramsIdSchema, 'params'), validate(updateSacramentSchema, 'body'), SacramentController.update);
