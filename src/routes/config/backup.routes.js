...
router.get('/download', auth, roleGuard('Coordinador', 'Subcoordinador'), BackupController.downloadBackup);

// Endpoint para el "Vigilante de Arranque" (Ejecución interna)
router.post('/trigger-auto', auth, roleGuard('Coordinador', 'Subcoordinador'), BackupController.triggerAutomaticBackup);
